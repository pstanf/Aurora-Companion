...
const SITE = {
  ...
  instagram: 'https://www.instagram.com/auroraforwomen/',
  instagramDisplay: '@auroraforwomen',
  facebook: 'https://www.facebook.com/profile.php?id=61577460575487',
  facebookDisplay: 'Aurora Healing and Recovery for Women',
  ...
  privacy: {
    ...
    journalBody: 'When you create a passcode, journal entry text is encrypted on this device — only you can unlock it. Aurora cannot read, back up, reset, or recover your passcode or entries. Check-ins and calm plans are not encrypted. If others can unlock this device, they may still access your journal while it is unlocked.',
    journalSub: 'Journal text encrypted with your passcode',
    journalLockSetupDesc: 'Your journal entry text will be encrypted on this device with a passcode only you know. Aurora cannot reset it if you forget. Check-ins and calm plans are not encrypted.',
    journalLockUnlockDesc: 'Enter your passcode to read and write encrypted journal entries.',
    journalSavedToast: 'Saved — encrypted on this device.',
    connectTitle: 'Your data & privacy',
    connectBody: 'Aurora Companion does not collect, access, transmit, or store your check-ins, journal entries, calm plans, or other personal content. When you create a journal passcode, journal entry text is encrypted on your device. Check-ins, calm plans, and check-in notes are not encrypted. We cannot recover lost passcodes or journal content. Other information stays on your device only and does not sync to other devices. You are responsible for securing the device you use.',
    disclaimer: 'This companion is an optional wellness tool and is not required for participation in Aurora services. Aurora Companion offers supportive tools and is not a medical device, diagnosis, or substitute for professional mental health care. For mental health support, call or text 988. If you are in immediate danger, call 911. Aurora is not responsible for personal content stored on your device or for access by others who use or unlock your device.',
    noticeVersion: '1.0',
    ...
    noticeBulletsLabel: 'Your Data on This Device',
    noticeBullets: [
      'Check-ins, journal entries, calm plans, and notes are stored only on this device within your browser.',
      'Aurora does not collect, access, receive, store, monitor, or transmit your personal entries, journal content, check-ins, or mood data.',
      'This companion is not an electronic health record, medical record, or treatment record system.',
      'This companion is an optional wellness tool and is not required for participation in Aurora services.',
      'When you create a journal passcode, the text of your journal entries is encrypted on this device.',
      'Check-ins, calm plans, and check-in notes are not encrypted — they are stored in your browser in plain form.',
      'Anyone who can unlock this device may be able to view information in the companion, especially while the journal is unlocked.',
      'If you clear your browser data, uninstall the app, lose or replace your device, reset your browser, or forget your journal passcode, your information may be permanently lost. Aurora cannot recover, restore, transfer, or access this information.',
      'You are responsible for securing the phone, tablet, or computer you use to access the companion.'
    ],
    noticeWellness: 'This companion is a wellness support tool only. It is not medical care, therapy, crisis intervention, diagnosis, treatment, or medical advice. It is designed to support — not replace — care from qualified healthcare professionals.',
    noticeEmergency: 'For mental health support, call or text 988. If you are in immediate danger or experiencing an emergency, call 911 or your local emergency services. Aurora staff do not monitor companion activity, journal entries, check-ins, or crisis-related content.',
    noticeFinePrint: 'By continuing, you acknowledge that your information remains on your device, Aurora cannot access or recover it, and you agree to these terms for Privacy Notice Version 1.0.',
    noticeAcceptLabel: 'I have read this notice. I understand my information stays on my device, I am responsible for securing my device, and this companion is a wellness support tool — not medical care.',
