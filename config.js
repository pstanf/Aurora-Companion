...
const SITE = {
  ...
  privacy: {
    ...
    noticeBullets: [
      ...
      'Journal entries may be protected with a passcode you choose. Check-ins, calm plans, and other content are not encrypted. Anyone who can unlock this device may be able to view information stored in the companion.',
